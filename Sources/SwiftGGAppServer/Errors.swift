...
struct Errors {
    ...
    static let Msg_UsernameLengthInValid = "用户名位数必须大于或等于\(Constant.Constant_Username_Length)"
    
    static let Code_PasswordLengthInValid = -10003
    static let Msg_PasswordLengthInValid = "密码位数必须大于或等于\(Constant.Constant_Password_Length)"
